...
function AjouterProduit() {
  ...
  return (
      <div>
        <h1 className="font-bold flex text-3xl">Ajouter Produit</h1>
        ...
        <div className="bg-gray-100 px-2 py-2 rounded-lg absolute ">
          <h3>Tailles</h3>
        ...
        <div className="flex">
          <label className="relative inline-flex items-center mb-5 cursor-pointer">
           ...
           <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Disponibilité</span>
          </label>
        </div>


        <div className="flex absolute pr-8">
